        ...
        <div class="row">
            <div class="col-sm-9 col-sm-offset-2">
                <div class="thanks-wrap">
                    ...
                    <h2>Thank you For using Our Service <strong>Your Register Has been Completed </strong></h2>
                    <p> Please Veryfie Your Email By Clicking The Button Below </p>
                </div>
                <button class="btn btn-success" style="margin:30px 0 ;padding:0 20px 10px;background:green;color:#fff"><a style="color:#fff"" href="{{url('confirm/'.$code)}}">
