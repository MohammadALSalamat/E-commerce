                                        ...
                                        <tr class="gradeX">
                                            ...
                                            <td style="width:46%">
                                                ...
                                                <a title="Edit This Item" class="tip-bottom"
                                                    href="{{ url('/admin/admin_reply/' . $Show->id) }}"><button
                                                        type="button" class="btn btn-success hvr-sweep-left"><i
                                                            class="fa fa-pencil" aria-hidden="true"></i>
                                                        Reply</button></a>
                                                <a title="Edit This Item" class="tip-bottom"
                                                    href="{{ url('/admin/MarkAsReadMessage/' . $Show->id) }}"><button
                                                        type="button" class="btn btn-danger hvr-sweep-left"><i
                                                            class="icon icon-ok" aria-hidden="true"></i>
