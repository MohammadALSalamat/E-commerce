...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb"> <a href="{{url('/admin/dashboard')}}" title="Go to Home" class="tip-bottom"><i
                    class="icon-home"></i>
                Home</a> <a href="{{url('/admin/viewbanners')}}" title="Go to banner" class="tip-bottom">Banners</a>
            <a href="#" class="current">Create New Banner</a> </div>
            ...
            <div class="span12">
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        <form class="form-horizontal" method="post" enctype="multipart/form-data" action="{{url('admin/banners/create')}}"
                            ...
                            <div class="control-group" style="width:50%">
                                ...
                                <div class="controls">
                                    <input type="text" name="ban_name" id="ban_name">
                                </div>
                            </div>
                            <div class="control-group" style="width:50%">
                                <label class="control-label">Description</label>
                                <div class="controls">
                                    <textarea name="ban_dec" id="ban_dec" cols="40" rows="5"></textarea>
                                </div>
                            </div>
                            <div class="control-group" style="width:50%">
