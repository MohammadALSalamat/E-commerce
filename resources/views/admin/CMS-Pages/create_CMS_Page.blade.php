...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb"> <a href="{{url('/admin/dashboard')}}" title="Go to Home" class="tip-bottom"><i
            ...
            <a href="#" class="current">Create CMS Page</a> </div>
            ...
            <div class="span12">
                <div class="widget-box">
                    <div class="widget-title"> <span class="icon"> <i class="icon-info-sign"></i> </span>
                        <h5>Create CMS Page</h5>
                    </div>
                    <div class="widget-content nopadding">
                        <form class="form-horizontal" method="post" enctype="multipart/form-data"
                            action="{{url('admin/store-cms-page')}}" name="Add_product" id="Add_product">
                            @csrf
                            ...
                            <div class="control-group" style="width:50%">
                                ...
                                <div class="controls">
                                    <textarea name="CMS_dec" id="CMS_dec" cols="40" rows="5" required></textarea>
                                </div>
                            </div>
                            <div class="control-group" style="width:50%">
